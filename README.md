...
| <h6>FRONTEND FUNCTION:</h6> | <h6>Upload files / directory: local_direct_ul_api</h6> |
| <h6>DEMO VIDEO:</h6> | <h6>SEE: [local_direct_ul_api-video-example.webm](https://github.com/nbanb/fbx-delta-nba_bash_api.sh/raw/refs/heads/nbanb-freebox-api/local_direct_ul_api-video-example.webm)</h6>|
| <h5>- NOTE 20250323:</h5> |  <h4>$${\color{purple}\text{  The library now support --debug / --trace options }}$$</h4> |
| <h5>- NOTE 20241117:</h5> |  <h5>$${\color{red}\text{  The library now support 'curl 8' with GNUTLS or OPENSSL backend }}$$</h5> |
...
API LISTING FUNCTIONS - LISTING FREEBOX EXTERNAL COMPONENTS
-----------------
...
#### *  Listing freeplug CPL network device :
...
```bash  
----------------------------------------------------------------------------------------------------------
FREEPLUG NETWORK 		 ID 	     STATE	SPEED		MODEL 	    ROLE	RATE
----------------------------------------------------------------------------------------------------------
B1:2B:EE:76:0F:05:0B  id: 34:27:92:1C:22:06  eth: up  speed: 1000  model: int7500  role: cco  rate: 39 M
B1:2B:EE:76:0F:05:0B  id: 34:27:92:1C:22:00  eth: up  speed: 1000  model: int7500  role: sta  rate: 39 M
```
...
##### Picture:
![image](https://github.com/user-attachments/assets/c4390f48-2543-417a-8c3c-96bce64a3a3f)
...
API LISTING FUNCTIONS - LISTING FREEBOX INTERNAL COMPONENTS
-----------------


<br />

#### *  Listing wifi AP (Freebox wireless radio devices):
...
---------------------------------------------------------------------------------------------------------
AP-1 id: 1  name: 5G 	 band: 5g 	width: 80  	chan: 36,40 	state: active
AP-0 id: 0  name: 2.4G 	 band: 2d4g 	width: 20  	chan: 9,0 	state: active
AP-3 id: 3  name: 5G1 	 band: 5g 	width: null  	chan: null 	state: disabled_power_saving
...
##### Picture:
![image](https://github.com/user-attachments/assets/94b68d58-11ff-46da-a4a6-a5c62de6b681)
...
#### *  Listing storage: internal SATA / NVMe + external USB disks:
...
```bash  
------------------------------------------------------------------------------------------------------------------------------
		DISK ID, TYPE, TABLE, STATE, SIZE (GB), SERIAL, MODEL, ONLINE / OFFLINE
------------------------------------------------------------------------------------------------------------------------------
DISK-0 id: 1000  type: usb	table: msdos	 	size: 1000 G  	serial: UNKNOWN SERIAL  model: UNKNOWN MODEL 
DISK-1 id: 2000  type: sata	table: raid	 	size: 8000 G  	serial: S5SSNF0T203885P model: Samsung SSD 870 QVO 8TB
DISK-2 id: 3000  type: sata	table: raid	 	size: 8000 G  	serial: S5SSNF0T203815L model: Samsung SSD 870 QVO 8TB
DISK-3 id: 4000  type: sata	table: raid	 	size: 8000 G  	serial: S5SSNF0T203864V model: Samsung SSD 870 QVO 8TB
DISK-4 id: 5000  type: sata	table: raid	 	size: 8000 G  	serial: S5SSNF0T203878Y model: Samsung SSD 870 QVO 8TB
DISK-5 id: 6000  type: raid	table: superfloppy 	size: 24000 G  	serial: UNKNOWN SERIAL  model: UNKNOWN MODEL 
```

<br />

##### Picture:
![image](https://github.com/user-attachments/assets/964bcfef-c69a-41b8-8bf3-07b27650b9e6)
...
#### *  Listing storage disk partition:
...
```bash  
------------------------------------------------------------------------------------------------------------------------------
		DISK ID, PARTITION ID, TYPE, SIZE (GiB), USED, FREE, LABEL, MOUNTED / UNMOUNTED
------------------------------------------------------------------------------------------------------------------------------
PART-0 id: 1001 dsk: 1000  type: ext4	size: 916 G 	used: 611 G  	free: 258 G 	label: 1000G
PART-1 id: 2000 dsk: 2000  type: raid	size: 0 G 	used: 0 G  	free: 0 G 	label: Volume 8001Go
PART-2 id: 3000 dsk: 3000  type: raid	size: 0 G 	used: 0 G  	free: 0 G 	label: Volume 8001Go 1
PART-3 id: 4000 dsk: 4000  type: raid	size: 0 G 	used: 0 G  	free: 0 G 	label: Volume 8001Go 2
PART-4 id: 5000 dsk: 5000  type: raid	size: 0 G 	used: 0 G  	free: 0 G 	label: Volume 8001Go 3
PART-5 id: 6000 dsk: 6000  type: ext4	size: 22258 G 	used: 14035 G  	free: 8223 G 	label: FBX24T
```

<br />

##### Picture:
![image](https://github.com/user-attachments/assets/d5a1d842-cc24-4cba-ad57-3d3013c0bbb5)
